...
hl.config({
    general = {
        ...
        col              = {
            ...
            inactive_border = "rgba(" .. colors.overlay0Alpha .. "aa)",
        },
...
hl.bind(mainMod .. " + Print",
    hl.dsp.exec_cmd([[grim -o "$(hyprctl monitors -j | jq -r '.[] | select(.focused).name')"]]))
hl.bind(mainMod .. " + CTRL + Print", hl.dsp.exec_cmd("slurp | grim -g -"))
...
hl.bind("XF86AudioMicMute", hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle"),
    { locked = true, repeating = true })
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("brightness brighter"), { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("brightness darker"), { locked = true, repeating = true })
