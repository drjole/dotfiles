...
-- Leave some space above/below the cursor at the beginning/end of the screen
vim.o.scrolloff = 8

-- Keep signcolumn on by default
vim.wo.signcolumn = 'yes'

-- Automatically reload files that changed outside of nvim
vim.o.autoread = true
...
vim.keymap.set('n', '<leader>c', vim.cmd.quit)
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'css', 'cpp', 'go', 'html', 'javascript', 'lua', 'python', 'ruby', 'rust', 'vimdoc', 'vim' },
